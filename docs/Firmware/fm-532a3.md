...
<div class="shadow-box-wavlink">
  ...
  <img src="/images/Vector.png" class="my-img">
	<h2><b>Software Version : M32A3_V1410_240222</b></h2>
  </div>
  <h3>Note :</h3>
  <p>1. Fix bugs.</p>
  <h4>MD5: 32AA29247B6B09C4F6EE85B15CA484F0 </h4> 
  <div style="text-align:center">
<a href="https://dl.wavlink.com/firmware/RD/WAVLINK-WN532A3-WO-M32A3_V1410_240222-GDBYFM.bin" target="_blank" class="md-button">Download</a>
</div>
</div>
<style>
.my-img {
