...
<div class="shadow-box-wavlink">
  ...
  <img src="/images/Vector.png" class="my-img">
	<h2><b>Version: 20220901</b></h2>
  </div>
  <h3>Note :</h3>
  <p>1. Check the model number in the back of the product or packing box( model number WL-WN533A8-C). If you download the incorrect firmware, it will damage your product WL-WN533A8-C Upgrade firmware.</p>
  <h4>Post Date : 01/09/2022 </h4> 
  <div style="text-align:center">
<a href="https://s3.amazonaws.com/files.wavlink.com/fw/2022/WN533A8-C-WAVLINK-WO-20210505-1087985.bin" target="_blank" class="md-button">Download</a>
</div>
</div>
<style>
.my-img {
