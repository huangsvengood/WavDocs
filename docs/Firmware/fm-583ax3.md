...
<div class="shadow-box-wavlink">
  ...
  <h3> Release Note :</h3>
  <p>1. New wizard ui.</p>
  <p>2. Rectify the wps connection error.</p>
  <p>3. Support pppoe account password set 64 bits ; Support wifi set 32-bit ssid.</p>
...
<div class="shadow-box-wavlink">
  <div style="text-align:center;">	
	<h2><b>Version : 2023811</b></h2>
  </div>
  <h4>Post Date: 11/08/2023 </h4> 
  <div style="text-align:center">
