...
<div class="shadow-box-wavlink">
  ...
  <img src="/images/Vector.png" class="my-img">
        <h2><b>Software version : M72HP3_V230525</b></h2>
  </div>
  <h3> Release Note :</h3>
  <p>1. Fix bugs.</p>
  <p>2. Add mesh mode.</p>
  <p>3. Add signal adjustment, security settings, remote control, port forwarding and other functions.
  <h4>MD5 : 740c1fac3da64a6cb076443ef6ed9ce4</h4>
  <div style="text-align:center">
<a href="https://dl.wavlink.com/firmware/RD/WINSTAR_WN572HP3-A-R2-M72HP3_V230525-WO-4611b6e-GD_BY_FM.bin" target="_blank" class="md-button">Download</a>
</div>
</div>
