...
<div class="shadow-box-wavlink">
  ...
  <h3> Note :</h3>
  <p>1. Check the model number in the back of the product or packing box( model number WL-WN530H4). If you download the incorrect firmware, it will damage your product WL-WN530H4 Upgrade firmware.</p>
  <h4>Post Date : 16/08/2022</h4> 
  <div style="text-align:center">
<a href="https://dl.wavlink.com/drivers/Firmware/English/WN530H4-WAVLINK_20220721.bin" target="_blank" class="md-button">Download</a>
</div>
</div>
<style>
.my-img {
