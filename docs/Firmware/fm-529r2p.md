...
<div class="shadow-box-wavlink">
  ...
  <img src="/images/Vector.png" class="my-img">
	<h2><b>Version : 20180301</b></h2>
  </div>
  <h3> Note :</h3>
  <p>1. check your model number in the back of the product or packing box( model number WN529R2P). If you download the incorrect firmware,it will damage your product.</p>
  <h4>Post Date : 04/11/2019</h4> 
  <div style="text-align:center">
<a href="https://files.wavlink.com/fw/2019/07/01/WAVLINK-WL_R2-1.26.8-20180301.zip" target="_blank" class="md-button">Download</a>
</div>
</div>
<style>
.my-img {
