...
<div class="shadow-box-wavlink">
  ...
  <img src="/images/Vector.png" class="my-img">
	<h2><b>Software version : M88HX3_V240615</b></h2>
  </div>
  <h3> Release Note :</h3>
  <p>1. Added Mesh AP mode.</p>
  <p>2. Added parental control and signal regulation functions. </p>
  <p>3. Optimize updates. </p>
  <h4>MD5 ：a822b2c6d633e1766775ceb380f5f276 </h4> 
  <div style="text-align:center">
<a href="https://dl.wavlink.com/firmware/RD/WAVLINK-WN588HX3-B-WO-M88HX3_V240615-BYFM.bin" target="_blank" class="md-button">Download</a>
</div>
</div>
