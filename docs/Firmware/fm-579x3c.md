...
<div class="shadow-box-wavlink">
  ...
  <img src="/images/Vector.png" class="my-img">
	<h2><b>Software version : M79X3C_V231124</b></h2>
  </div>
  <h3> Release Note :</h3>
  <p>1. Fix bugs.</p>
  <p>2. Improve performance, optimize and update.</p>
  <h4>MD5:086dcc806b531000746f9c8214268adc</h4> 
  <div style="text-align:center">
<a href="https://dl.wavlink.com/firmware/RD/WN579X3C_M79X3C_V231124_WAVLINK_WO_GD_BY_FM.bin" target="_blank" class="md-button">Download</a>
</div>
</div>
<style>
.my-img {
