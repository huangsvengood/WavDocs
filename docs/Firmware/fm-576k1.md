...
<div class="shadow-box-wavlink">
  ...
  <img src="/images/Vector.png" class="my-img">
	<h2><b>Software version : M76K1_V210106</b></h2>
  </div>
  <h3> Release Note :</h3>
  <p>1. Fix security bugs.</p>
  <h4></h4> 
  <div style="text-align:center">
<a href="https://dl.wavlink.com/firmware/RD/WN576K1-WAVLINK_WO_20210106.bin" target="_blank" class="md-button">Download</a>
</div>
</div>
