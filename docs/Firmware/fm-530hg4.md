...
<div class="shadow-box-wavlink">
  ...
  <img src="/images/Vector.png" class="my-img">
	<h2><b>Version: 20220801</b></h2>
  </div>
  <h3>Note :</h3>
  <p>1. Check the model number in the back of the product or packing box( model number WL-WN530HG4). If you download the incorrect firmware, it will damage your product WL-WN530HG4 Upgrade firmware.</p>
  <h4>Post Date : 16/08/2022 </h4> 
  <div style="text-align:center">
<a href="https://s3.amazonaws.com/files.wavlink.com/fw/2022/WN530HG4-WAVLINK_20220809" target="_blank" class="md-button">Download</a>
</div>
</div>
<style>
.my-img {
