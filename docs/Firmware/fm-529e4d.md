...
<div class="shadow-box-wavlink">
  <div style="text-align:center;">	
	<h2><b>Software version : M29E4D_V230612</b></h2>
  </div>
  <h3> Release Note :</h3>
  <p>1. Increase the cleaning of login page cookies to prevent cache conflicts caused by <br>switching between new and old UI products from preventing login.</p>
  <p>2. Optimize 4g dialing scripts.</p>
  <p>3. Replace the upnp version.</p>
  <h4>Post Date : 18/07/2023</h4> 
  <div style="text-align:center">
<a href="https://files2.wavlink.com/drivers/fw/WN529E4D_WAVLINK-M29E4D_V230612-2023-06-12--dede714.bin" target="_blank" class="md-button">Download</a>
</div>
</div>
