...
<div class="shadow-box-wavlink">
  ...
  <img src="/images/Vector.png" class="my-img">
	<h2><b>Software version : M29E4D_V231110</b></h2>
  </div>
  <h3> Release Note :</h3>
  <p>1. New UI software release.Please reset after upgrade.</p>
  <h4>MD5:8a944275bfad6c7cefc951a4f6dcc9c0</h4> 
  <div style="text-align:center">
<a href="https://dl.wavlink.com/firmware/RD/WN529E4D_WAVLINK-WO-2023-11-10-FMBYGD-044a3a28.bin" target="_blank" class="md-button">Download</a>
</div>
</div>
<style>
.my-img {
