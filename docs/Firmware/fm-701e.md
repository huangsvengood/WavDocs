...
<div class="shadow-box-wavlink">
  ...
  <img src="/images/Vector.png" class="my-img">
	<h2><b>Software version : M01AE_V240305</b></h2>
  </div>
  <h3> Release Note :</h3>
  <p>1. New software release.</p>
  <h4>MD5：62825e19a9fafdeb8b2c872ed379654f</h4> 
  <div style="text-align:center">
<a href="https://dl.wavlink.com/firmware/RD/WINSTAR_WN701AE-WAVLINK-WO-M01AE_V240305-GD-FM-BY.bin" target="_blank" class="md-button">Download</a>
</div>
</div>
