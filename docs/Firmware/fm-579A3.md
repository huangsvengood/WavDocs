	...
	<div class="bannerContainer">
		<div class="banner">
			<div class="search_infoCenter">
				<h1>Model : AERIAL K/WL-WN579A3</h1>
...
<div class="shadow-box-wavlink">
  ...
  <img src="/images/Vector.png" class="my-img">
	<h2><b>Software Version : M79A3_V220323</b></h2>
  </div>
  <h3> Release Note :</h3>
  <p>1. Optimize and update. </p>
  <p>2. Fix bugs.</p>
  <h4>MD5 : 29b8d8d058a83c4dfb8f112a8a0c25bb </h4> 
  <div style="text-align:center">
<a href="https://dl.wavlink.com/firmware/RD/WN579A3-WAVLINK-WO-2022-03-23-854d73f.bin" target="_blank" class="md-button">Download</a>
</div>
</div>
<style>
.my-img {
