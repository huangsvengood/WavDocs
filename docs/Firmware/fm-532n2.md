...
<div class="shadow-box-wavlink">
  <div style="text-align:center;">	
	<h2><b>Version : 20180508</b></h2>
  </div>
  <h3> Note:</h3>
  <p>1. Check your model number in the back of the product or packing box( model number WN532N2). If<br> you download the incorrect firmware,it will damage your product.</p>
  <h4>Post Date : 04/11/2019</h4> 
  <div style="text-align:center">
<a href="https://files.wavlink.com/fw/2019/07/01/WAVLINK-W32N-1.26.8-20180508.zip" target="_blank" class="md-button">Download</a>
</div>
</div>
