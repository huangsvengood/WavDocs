	...
	<div class="bannerContainer">
		<div class="banner">
			<div class="search_infoCenter">
				<h1>Model : QUANTUM D4X/WL-WN531MX3</h1>
...
<div class="shadow-box-wavlink">
  ...
  <img src="/images/Vector.png" class="my-img">
	<h2><b>Software Version : M31MX1_V231013</b></h2>
  </div>
  <h3> Release Note :</h3>
  <p>1. Optimize and update. </p>
  <p>2. Fix bugs.</p>
  <h4>MD5：c016bbd3fe4d0e658fe4ea87d34062e2 </h4> 
  <div style="text-align:center">
<a href="https://dl.wavlink.com/firmware/RD/WN531MX1_WAVLINK-WO-2023-10-13-87a1d57-squashfs-fullimage.img" target="_blank" class="md-button">Download</a>
</div>
</div>
<style>
.my-img {
