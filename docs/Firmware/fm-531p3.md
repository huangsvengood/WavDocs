...
<div class="shadow-box-wavlink">
  ...
  <img src="/images/Vector.png" class="my-img">
	<h2><b>Version : 202383</b></h2>
  </div>
  <h3> Release Note :</h3>
  <p style="font-size: 16px;">1. Fix bugs.</p>
  <h4>Post Date: 03/08/2023 </h4> 
  <div style="text-align:center">
<a href="https://files2.wavlink.com/drivers/fw/WN531P3-WAVLINK-WO-20230525.bin" target="_blank" class="md-button">Download</a>
</div>
</div>
<style>
.my-img {
