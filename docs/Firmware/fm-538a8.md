...
<div class="shadow-box-wavlink">
  ...
  <h3>Note :</h3>
  <p>1. Check your model number in the back of the product or packing box( model number WN538A8). If you download the incorrect firmware,it will damage your product.</p>
  <p>2. Add WPA2PSK encryption.</p>
  <p>3. Change the maximum length of a pppoe user name to 64. </p>
