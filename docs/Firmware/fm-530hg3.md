	...
	<div class="bannerContainer">
		<div class="banner">
			<div class="search_infoCenter">
				<h1>Model : QUANTUM D2G/WL-WN530G3</h1>
...
<div class="shadow-box-wavlink">
  ...
  <img src="/images/Vector.png" class="my-img">
	<h2><b>Software Version : M30HG3_V231021</b></h2>
  </div>
  <h3> Release Note :</h3>
  <p>1. New software release. </p>
  <p>2. Fix bugs.</p>
  <h4>MD5:cbc5c5af0c1517865773ee9cf8d093f1</h4> 
  <div style="text-align:center">
<a href="https://dl.wavlink.com/firmware/RD/WN530HG3A_M30HG3_V231021_WAVLINK_WO_GD_BY_FM.bin" target="_blank" class="md-button">Download</a>
</div>
</div>
<style>
.my-img {
