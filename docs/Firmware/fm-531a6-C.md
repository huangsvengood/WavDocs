	...
	<div class="bannerContainer">
		<div class="banner">
			<div class="search_infoCenter">
				<h1>Model : QUANTUM D6/WL-WN531A6-C</h1>
...
<div class="shadow-box-wavlink">
  <div style="text-align:center;">	
	<h2><b>Version: 20200829</b></h2>
  </div>
  <h3> Note :</h3>
  <p>1. Check the model number in the back of the product or packing box( model number QUANTUM D6 / WN531A6-C). If you download the incorrect firmware,it will damage your product QUANTUM D6 / WN531A6-C Upgrade firmware.</p>
  <h4>Post Date : 23/12/2020 </h4> 
  <div style="text-align:center">
<a href="https://files.wavlink.com/fw/router/WN531A6-C-WAVLINK-WO-20200829-18b3dd11" target="_blank" class="md-button">Download</a>
</div>
</div>
