	...
	<div class="bannerContainer">
		<div class="banner">
			<div class="search_infoCenter">
				<h1>Model : MIGHTY EX2/WL-WN587X3</h1>
...
<div class="shadow-box-wavlink">
  ...
  <img src="/images/Vector.png" class="my-img">
	<h2><b>Software Version : M87X3A_V240118</b></h2>
  </div>
  <h3> Release Note :</h3>
  <p>1. Changed the length of the broadband dial-up account password from 32 to 64 characters. </p>
  <p>2. Fix bugs.</p>
...
<div class="shadow-box-wavlink">
  <div style="text-align:center;">	
	<h2><b>Software Version : M87X3A_V230815</b></h2>
  </div>
  <h3> Release Note :</h3>
  ...
  <div style="text-align:center">
<a href="https://dl.wavlink.com/firmware/RD/WAVLINK_WN587X3-A_M87X3A_V230815_WO-GDBYFM.bin" target="_blank" class="md-button">Download</a>
</div>
</div>
<style>
.my-img {
