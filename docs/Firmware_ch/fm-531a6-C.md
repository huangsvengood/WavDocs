	...
	<div class="bannerContainer">
		<div class="banner">
			<div class="search_infoCenter">
				<h1>型号 : QUANTUM D6/WL-WN531A6-C</h1>
...
<div class="shadow-box-wavlink">
  <div style="text-align:center;">	
	<h2><b>固件版本: 20200829</b></h2>
  </div>
  <h3> 注意 :</h3>
  <p>1. 检查产品或包装盒背面的型号(型号 QUANTUM D6/WN531A6-C) 。如果您下载了不正确的固件，将会损坏您的产品QUANTUM D6/WN531A6-C升级固件。</p>
  <h4>更新日志 : 2020/12/23 </h4> 
  <div style="text-align:center">
<a href="https://files.wavlink.com/fw/router/WN531A6-C-WAVLINK-WO-20200829-18b3dd11" target="_blank" class="md-button">下载</a>
</div>
</div>
