...
<div class="shadow-box-wavlink">
  ...
  <h3> 注意 :</h3>
  <p>1. 检查产品或包装盒背面的型号(型号WL-WN530H4)。如果您下载了不正确的固件，将会损坏您的产品WL-WN530H4升级固件。</p>
  <h4>更新日期 : 2022/08/16</h4> 
  <div style="text-align:center">
<a href="https://dl.wavlink.com/drivers/Firmware/English/WN530H4-WAVLINK_20220721.bin" target="_blank" class="md-button">下载</a>
</div>
</div>
