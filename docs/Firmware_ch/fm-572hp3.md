...
<div class="shadow-box-wavlink">
  ...
  <img src="/images/Vector.png" class="my-img">
        <h2><b>软件版本 : M72HP3_V230525</b></h2>
  </div>
  <h3> 更新日志 :</h3>
  <p>1. 修复问题。</p>
  <p>2. 增加Mesh路由模式。</p>
  <p>3. 增加信号调节、安全设置、远程管理、端口转发等功能。</p>
  <h4>MD5 : 740c1fac3da64a6cb076443ef6ed9ce4</h4>
  <div style="text-align:center">
<a href="https://dl.wavlink.com/firmware/RD/WINSTAR_WN572HP3-A-R2-M72HP3_V230525-WO-4611b6e-GD_BY_FM.bin" target="_blank" class="md-button">下载</a>
</div>
</div>
...
<div class="shadow-box-wavlink">  
  <div style="text-align:center;">	
    <img src="/images/Vector.png" class="my-img">
	<h2><b>软件版本 : M72HP3_V231101</b></h2>
  </div>
  <h3> 更新日志 :</h3>
  <p>1. 优化更新。</p>
  <h4>MD5 : 4936b7d4e04306bac7d3ac115212056b</h4>
  <div style="text-align:center">
<a href="https://dl.wavlink.com/firmware/RD/WINSTAR_WN572HP3-A-R2-M72HP3_V231101-WO.bin" target="_blank" class="md-button">下载</a>
</div>
</div>
-->
<style>
