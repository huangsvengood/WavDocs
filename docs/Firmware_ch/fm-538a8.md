	...
	<div class="bannerContainer">
		<div class="banner">
			<div class="search_infoCenter">
				<h1>型号 : Quantum DAX/WL-WN538A8</h1>
...
<div class="shadow-box-wavlink">
  <div style="text-align:center;">	
	...
	<h2><b>固件版本 : V31.0.0.21</b></h2>
  </div>
  <h3>注意 :</h3>
  <p>1. 检查产品或包装盒背面的型号(型号 WN538A8)。如果您下载了不正确的固件，将会损坏您的产品。</p>
  <p>2. 增加WPA2PSK加密。</p>
  <p>3. 更改pppoe用户名的最大长度为64。</p>
  <h4>更新日期 : 2023/08/02</h4> 
  <div style="text-align:center">
<a href="https://files2.wavlink.com/drivers/Firmware/English/QUANTUM_DAX_703004927_V31.0.0.21_20220425.bin" target="_blank" class="md-button">下载</a>
</div>
</div>
