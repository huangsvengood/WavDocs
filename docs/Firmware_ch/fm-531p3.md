...
<div class="shadow-box-wavlink">
  <div style="text-align:center;">	
	...
	<h2><b>固件版本 : 202383</b></h2>
  </div>
  <h3> 更新日志 :</h3>
  <p style="font-size: 16px;">1. 修复问题。</p>
  <h4>更新日期 : 2023/08/03 </h4> 
  <div style="text-align:center">
<a href="https://files2.wavlink.com/drivers/fw/WN531P3-WAVLINK-WO-20230525.bin" target="_blank" class="md-button">下载</a>
</div>
</div>
