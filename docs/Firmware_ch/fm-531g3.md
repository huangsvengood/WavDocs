...
<div class="shadow-box-wavlink">
  <div style="text-align:center;">	
	<h2><b>固件版本 : 2023615</b></h2>
  </div>
  <h3> 更新日志 :</h3>
  <p>1. USB新增支持NTFS文件系统。</p>
  <h4>更新日期 : 2023/06/15 </h4> 
  <div style="text-align:center">
<a href="https://files2.wavlink.com/drivers/fw/WN531G3-WAVLINK_20221012.bin" target="_blank" class="md-button">下载</a>
</div>
</div>
