...
<div class="shadow-box-wavlink">
  ...
  <img src="/images/Vector.png" class="my-img">
	<h2><b>固件版本 : M70HN2B_V230718</b></h2>
  </div>
  <h3>更新日志 :</h3>
  <p>1. 新UI发布。 </p>
  <h4>MD5：ae0fdb1e2ad637147a1c25275bf7bc09</h4> 
  <div style="text-align:center">
<a href="https://dl.wavlink.com/firmware/RD/WAVLINK-WN570HN2B-A-M70HN2B-WO-20230718-GDBYFM.bin" target="_blank" class="md-button">下载</a>
</div>
</div>
<style>
.my-img {
