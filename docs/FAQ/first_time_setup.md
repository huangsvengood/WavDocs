...
!!! example ""
	...
	=== "==Windows=="
		...
		8 . After setting, click Save and wait for the device configuration to be completed. After the Refresh button appears, click __Refresh__ to complete the initial setting of the device.
		...
		9 . After clicking Refresh, you need to re-enter the login password. This login password is the password you customized. After entering the password, click Login to log in. After successful login, you can see the following page.
	...
	=== "{==MacOS==}"
		...
		5 . Copy the address, open the browser, enter __http://192.168.20.1__ in the address bar and press Enter on the keyboard to enter the router management page.
		...
		7 . After configuring the Internet, select your time zone and country, and customize your WiFi name and password. For device management passwords, you can refer to the instructions below.(it is recommended that you use a strong password : The password contains uppercase and lowercase letters, numbers, and special symbols such as " @, ?, * ", etc.)
		...
		8 . After setting all parameters, click __Save__. The device will start updating. After updating to 100%, click __refresh__.
		...
		!!! info "App Download"
			Scan the QR code with your mobile phone to download the Wav router app and manage your device conveniently.
		9 . After the refresh is successful, log in to the device management interface again, enter your customized password and click __Login__ to log in.
		
		<div style="text-align: center;">
		<img class="boxshadow" src="/images/mac013.png">
		</div>
		
		10 . After successful login, you will see the following interface. This interface is the administrator's homepage. You can manage and learn about your device on this interface. For more function details, please click __[More](/feature_guide/)__.
